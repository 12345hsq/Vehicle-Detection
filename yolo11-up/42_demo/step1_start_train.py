...
results = model.train(data=r'D:\YOLO\yolo11-up\ultralytics\cfg\datasets\A_my_data.yaml', project="./runs", epochs=100, imgsz=640, device=[0], workers=0, batch=4, cache=True, amp=False)  # CPU 开始训练
# results = model.train(data='G:/Upppppdate/000-AAAAA-standard-code/yolo11/yolo11-up/ultralytics/cfg/datasets/A_my_data.yaml', project="./runs", epochs=100, imgsz=640, device=[0, ], workers=0, batch=4, cache=True, amp=False)  # CPU 开始训练
