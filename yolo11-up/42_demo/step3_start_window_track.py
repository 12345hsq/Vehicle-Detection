...
import numpy as np
# 常用的字符串常量
WINDOW_TITLE ="目标检测"            # 系统上方标题
WELCOME_SENTENCE = "基于YOLOv11的车辆检测与追踪系统"   # 欢迎的句子
ICON_IMAGE = "images/UI/icon.png"                 # 系统logo界面
IMAGE_LEFT_INIT = "images/UI/left.jpeg"              # 图片检测界面初始化左侧图像
IMAGE_RIGHT_INIT = "images/UI/left.jpeg"          # 图片检测界面初始化右侧图像
USERNAME = "12345"
PASSWORD = "12345"
...
class MainWindow(QTabWidget):
    ...
    def initUI(self):
        ...
        """
        # ********************* 图片识别界面 *****************************
        font_title = QFont('黑体', 16)
        font_main = QFont('黑体', 14)
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("车辆图片检测")
        ...
        self.img_num_label = QLabel("当前检测结果：等待检测")
        ...
        self.mp4_detection_btn = QPushButton("视频检测")
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/ui.jpeg'))
        ...
        config_icon_label.setPixmap(QPixmap("images/UI/last.jpeg"))
    ...
    def upload_img(self):
        ...
        if fileName: # 如果存在文件名称则对图像进行处理
            ...
            self.right_img.setPixmap(QPixmap(IMAGE_RIGHT_INIT))
            self.img_num_label.setText("当前检测结果：等待检测")
